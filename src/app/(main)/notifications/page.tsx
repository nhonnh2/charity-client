      ...
      <div className='flex items-center justify-between mb-6'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Cập nhật từ chiến dịch và tương tác
          </p>
        </div>
            ...
            <CardContent className='space-y-4 p-0'>
              ...
              <div className='flex items-start gap-4 p-4 hover:bg-muted/50 transition-colors relative'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-muted-foreground mt-1'>
                    ...
                    thành giai đoạn 1 và đang chờ xác nhận để giải ngân giai
                    đoạn 2.
                  </p>
              ...
              <div className='flex items-start gap-4 p-4 hover:bg-muted/50 transition-colors'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-muted-foreground mt-1'>
                    <span className='font-medium'>Nguyễn Văn B</span> đã đóng
                    góp 2.000.000 VNĐ cho chiến dịch "Xây trường học cho trẻ em
                    vùng cao".
                  </p>
                  <Button variant='link' className='h-auto p-0 text-sm mt-1'>
                    Gửi lời cảm ơn
              ...
              <div className='flex items-start gap-4 p-4 hover:bg-muted/50 transition-colors'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-muted-foreground mt-1'>
                    <span className='font-medium'>Trần Thị C</span> và{' '}
                    <span className='font-medium'>5 người khác</span> đã thích
                    bài đăng của bạn về cập nhật chiến dịch.
                  </p>
                  <Button variant='link' className='h-auto p-0 text-sm mt-1'>
                    Xem bài đăng
                  </Button>
            ...
            <CardContent className='space-y-4 p-0'>
              ...
              <div className='flex items-start gap-4 p-4 hover:bg-muted/50 transition-colors'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-muted-foreground mt-1'>
                    <span className='font-medium'>Lê Văn D</span> đã nhắc đến
                    bạn trong một bình luận: "Cảm ơn{' '}
                    <span className='text-blue-600'>@nguyenvana</span> vì chiến
                    dịch ý nghĩa này!"
                  </p>
                  <Button variant='link' className='h-auto p-0 text-sm mt-1'>
                    Xem bình luận
              ...
              <div className='flex items-start gap-4 p-4 hover:bg-muted/50 transition-colors'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-muted-foreground mt-1'>
                    Điểm uy tín của bạn đã tăng 5 điểm sau khi hoàn thành giai
                    đoạn 1 của chiến dịch "Xây trường học cho trẻ em vùng cao".
                  </p>
                  <Button variant='link' className='h-auto p-0 text-sm mt-1'>
                    Xem hồ sơ
                  </Button>
              ...
              <div className='flex items-start gap-4 p-4 hover:bg-muted/50 transition-colors'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-muted-foreground mt-1'>
                    Chiến dịch "Xây trường học cho trẻ em vùng cao" của bạn đã
                    được xác minh và đã xuất hiện trong mục chiến dịch nổi bật.
                  </p>
                  <Button variant='link' className='h-auto p-0 text-sm mt-1'>
                    Xem chiến dịch
                  </Button>
            ...
            <CardContent className='p-6'>
              <div className='flex flex-col items-center justify-center py-8 text-center'>
                ...
                <p className='text-muted-foreground mt-1 max-w-md'>
                  Đang hiển thị thông báo liên quan đến chiến dịch. Bạn có thể
                  thay đổi bộ lọc bất kỳ lúc nào.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className='p-6'>
              <div className='flex flex-col items-center justify-center py-8 text-center'>
                ...
                <h3 className='text-lg font-medium'>Đang lọc thông báo</h3>
                <p className='text-muted-foreground mt-1 max-w-md'>
                  Đang hiển thị thông báo liên quan đến nhắc đến. Bạn có thể
                  thay đổi bộ lọc bất kỳ lúc nào.
                </p>
              </div>
            </CardContent>
          ...
          <Card>
            <CardContent className='p-6'>
              <div className='flex flex-col items-center justify-center py-8 text-center'>
                ...
                <h3 className='text-lg font-medium'>Đang lọc thông báo</h3>
                <p className='text-muted-foreground mt-1 max-w-md'>
                  Đang hiển thị thông báo liên quan đến lượt thích. Bạn có thể
                  thay đổi bộ lọc bất kỳ lúc nào.
                </p>
              </div>
            </CardContent>
