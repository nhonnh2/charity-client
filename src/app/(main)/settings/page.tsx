            ...
            <TabsContent value='profile' className='mt-0'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Thông tin này sẽ được hiển thị công khai trên trang hồ sơ
                    của bạn
                  </CardDescription>
                </CardHeader>
                <CardContent className='space-y-6'>
                  <div className='space-y-4'>
                    ...
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        defaultValue='anhsanghyvong.org'
                      />
                    </div>
                  </div>
                ...
                <CardContent className='space-y-6'>
                  <div className='space-y-4'>
                    ...
                    <div className='space-y-2'>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Hiệu ứng chuyển động có thể gây khó chịu cho một số
                        người dùng
                      </p>
                    </div>
                  </div>
                      ...
                      <div className='flex items-center justify-between'>
                        <Label htmlFor='email-campaigns' className='flex-1'>
                          ...
                          <p className='font-normal text-sm text-muted-foreground'>
                            Nhận thông báo khi có cập nhật về chiến dịch bạn đã
                            đóng góp
                          </p>
                        </Label>
                    ...
                    <div className='space-y-2'>
                      <div className='flex items-center justify-between'>
                        <Label htmlFor='email-donations' className='flex-1'>
                          Đóng góp mới
                          <p className='font-normal text-sm text-muted-foreground'>
                            Nhận thông báo khi có người đóng góp cho chiến dịch
                            của bạn
                          </p>
                        </Label>
                    ...
                    <div className='space-y-2'>
                      <div className='flex items-center justify-between'>
                        <Label htmlFor='email-mentions' className='flex-1'>
                          Nhắc đến
                          <p className='font-normal text-sm text-muted-foreground'>
                            Nhận thông báo khi có người nhắc đến bạn trong bình
                            luận
                          </p>
                        </Label>
                    ...
                    <div className='space-y-2'>
                      <div className='flex items-center justify-between'>
                        <Label htmlFor='email-marketing' className='flex-1'>
                          Tin tức và cập nhật
                          <p className='font-normal text-sm text-muted-foreground'>
                            Nhận thông tin về tính năng mới và cập nhật từ
                            TrustCharity
                          </p>
                        </Label>
                    ...
                    <div className='space-y-2'>
                      <div className='flex items-center justify-between'>
                        <Label htmlFor='push-mentions' className='flex-1'>
                          ...
                          <p className='font-normal text-sm text-muted-foreground'>
                            Nhận thông báo khi có người nhắc đến hoặc bình luận
                            về bài đăng của bạn
                          </p>
                        </Label>
            ...
            <TabsContent value='privacy' className='mt-0'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Quản lý cài đặt quyền riêng tư và bảo mật
                  </CardDescription>
                </CardHeader>
                <CardContent className='space-y-6'>
                  <div className='space-y-4'>
                    ...
                    <div className='space-y-2'>
                      <div className='flex items-center justify-between'>
                        <Label htmlFor='private-profile' className='flex-1'>
                          Hồ sơ riêng tư
                          <p className='font-normal text-sm text-muted-foreground'>
                            Chỉ những người bạn cho phép mới có thể xem hồ sơ
                            của bạn
                          </p>
                        </Label>
                  ...
                  <Alert variant='destructive'>
                    ...
                    <AlertDescription>
                      Thay đổi cài đặt quyền riêng tư có thể ảnh hưởng đến cách
                      người khác tương tác với bạn và chiến dịch của bạn.
                    </AlertDescription>
                  </Alert>
                </CardContent>
                <CardFooter className='flex justify-between border-t px-6 py-4'>
            ...
            <TabsContent value='wallet' className='mt-0'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Quản lý ví blockchain và giao dịch của bạn
                  </CardDescription>
                </CardHeader>
                <CardContent className='space-y-6'>
                  <Alert className='bg-blue-50 text-blue-800 border-blue-200'>
                    ...
                    <AlertDescription>
                      Kết nối ví blockchain để nhận và gửi tiền quyên góp. Chúng
                      tôi sử dụng mạng Polygon để giảm phí giao dịch.
                    </AlertDescription>
                  </Alert>
                          ...
                          <div className='flex items-center gap-3'>
                            ...
                            <div>
                              <h4 className='text-sm font-medium'>
                                {i % 2 === 0 ? 'Đóng góp đi' : 'Đóng góp đến'}
                              </h4>
                              <p className='text-xs text-muted-foreground'>
            ...
            <TabsContent value='language' className='mt-0'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Quản lý cài đặt ngôn ngữ và khu vực
                  </CardDescription>
                </CardHeader>
                <CardContent className='space-y-6'>
                  <div className='space-y-4'>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      Bạn có thể bật tính năng dịch tự động để xem nội dung bằng
                      ngôn ngữ ưa thích của mình.
                    </AlertDescription>
                  </Alert>
                    ...
                    <div className='space-y-4'>
                      ...
                      <div className='space-y-2'>
                        <div className='rounded-lg border p-4'>
                          <h4 className='font-medium'>
                            Làm sao để tạo chiến dịch từ thiện?
                          </h4>
                          <p className='mt-1 text-sm text-muted-foreground'>
                            Để tạo chiến dịch, bạn cần đăng ký tài khoản, xác
                            minh danh tính qua KYC, sau đó nhấp vào nút "Tạo
                            chiến dịch" và điền đầy đủ thông tin theo hướng dẫn.
                          </p>
                        </div>
                        <div className='rounded-lg border p-4'>
                          <h4 className='font-medium'>
                            Làm sao để biết tiền quyên góp được sử dụng đúng mục
                            đích?
                          </h4>
                          <p className='mt-1 text-sm text-muted-foreground'>
                            Mọi giao dịch đều được ghi lại trên blockchain và có
                            thể kiểm tra. Ngoài ra, tiền quyên góp được giải
                            ngân theo từng giai đoạn, và người tạo chiến dịch
                            phải cung cấp bằng chứng chi tiêu.
                          </p>
                        </div>
                        <div className='rounded-lg border p-4'>
                          <h4 className='font-medium'>
                          ...
                          <p className='mt-1 text-sm text-muted-foreground'>
                            TrustCharity thu 2.5% phí trên mỗi giao dịch thành
                            công để duy trì nền tảng và phát triển các tính năng
                            mới. Phí này thấp hơn nhiều so với các nền tảng gây
                            quỹ truyền thống.
                          </p>
                        </div>
                      </div>
                        ...
                        <Card className='bg-muted/50'>
                          <CardContent className='p-4'>
                            <div className='flex flex-col items-center text-center space-y-2 py-2'>
                              ...
                              <p className='text-sm text-muted-foreground'>
                                Gửi email cho chúng tôi và nhận phản hồi trong
                                vòng 24 giờ
                              </p>
                              <Button variant='outline' size='sm'>
                        ...
                        <Card className='bg-muted/50'>
                          <CardContent className='p-4'>
                            <div className='flex flex-col items-center text-center space-y-2 py-2'>
                              ...
                              <p className='text-sm text-muted-foreground'>
                                Chat với đội ngũ hỗ trợ của chúng tôi trong giờ
                                làm việc
                              </p>
                              <Button
                                size='sm'
