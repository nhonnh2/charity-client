  ...
  const getUserCampaigns = () => [
    {
      ...
      description:
        'Mang y tế đến với người dân vùng cao xa xôi, cung cấp thiết bị y tế và thuốc men cần thiết',
    ...
    },
    {
      ...
      description:
        'Xây dựng trường học đạt chuẩn cho trẻ em vùng khó khăn, tạo môi trường học tập tốt nhất',
    ...
    },
    {
      ...
      description:
        'Phục hồi rừng và môi trường sinh thái, chống xói mòn đất và tạo không gian xanh',
      status: 'funding' as const,
      raised: 45000000,
      goal: 200000000,
      progress: 22,
    ...
    },
    {
      ...
      description:
        'Trao học bổng cho sinh viên vượt khó học giỏi, giúp các em có cơ hội phát triển tương lai',
      status: 'funding' as const,
      raised: 15000000,
      goal: 50000000,
      progress: 30,
    ...
    },
    {
      ...
      description:
        'Xây cầu giúp học sinh đi học an toàn, không còn phải lội suối khi mùa mưa lũ',
      status: 'implementing' as const,
      raised: 80000000,
      goal: 80000000,
      progress: 100,
      ...
      colorScheme: 'gradient' as const,
      imageSrc:
        'https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=400&h=200&fit=crop&crop=center&auto=format&q=80',
    },
  ];
    ...
    <div className='container mx-auto px-4 py-6 max-w-7xl'>
      ...
      <div className='mt-16 mb-8'>
        ...
        <div className='mt-4 flex flex-col gap-4'>
          <p>
            Người sáng lập tổ chức phi lợi nhuận Ánh Sáng Hy Vọng, hoạt động
            trong lĩnh vực giáo dục và hỗ trợ trẻ em vùng cao từ năm 2018.
          </p>
            ...
            <div className='md:col-span-2 space-y-6'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Quản lý ví blockchain và xem thông tin giao dịch
                  </CardDescription>
                </CardHeader>
                    ...
                    <div className='space-y-4'>
                      {[1, 2, 3, 4, 5].map(i => (
                        ...
                        >
                          ...
                          <div className='text-right'>
                            <div
                              className={`font-medium ${i % 2 === 0 ? 'text-red-600' : 'text-green-600'}`}
                            >
                              {i % 2 === 0 ? '-' : '+'}
                              {(i * 500000).toLocaleString()} VNĐ
                            </div>
            ...
            <div className='space-y-6'>
              <Card>
                ...
                <CardContent className='space-y-4'>
                  <div className='space-y-2'>
                    <h4 className='font-medium'>
                      Làm sao để kết nối MetaMask?
                    </h4>
                    <p className='text-sm text-muted-foreground'>
                      Cài đặt tiện ích mở rộng MetaMask, tạo ví, sau đó nhấp vào
                      nút "Kết nối ví" trên trang hồ sơ.
                    </p>
                  </div>
                  <div className='space-y-2'>
                    <h4 className='font-medium'>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Chúng tôi không lưu trữ private key của bạn. Tất cả giao
                      dịch đều yêu cầu xác nhận qua MetaMask.
                    </p>
                  </div>
                  <div className='space-y-2'>
                    <h4 className='font-medium'>
                      Tôi cần token gì để đóng góp?
                    </h4>
                    <p className='text-sm text-muted-foreground'>
                      Bạn có thể đóng góp bằng MATIC (token gốc của Polygon)
                      hoặc USDT trên mạng Polygon.
                    </p>
                  </div>
                </CardContent>
                <CardFooter>
              ...
              <Alert className='bg-blue-50 border-blue-200'>
                ...
                <AlertDescription className='text-blue-700'>
                  Bạn có thể kết nối thêm ví khác hoặc thay đổi ví hiện tại
                  trong phần Cài đặt.
                </AlertDescription>
              </Alert>
            </div>
        ...
        <TabsContent value='about' className='space-y-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Thông tin chi tiết về Nguyễn Văn A
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-6'>
              <div>
                ...
                <p>
                  Ánh Sáng Hy Vọng là tổ chức phi lợi nhuận được thành lập vào
                  năm 2018, với sứ mệnh mang đến cơ hội giáo dục và hỗ trợ y tế
                  cho trẻ em vùng cao Việt Nam. Chúng tôi đã thực hiện hơn 20 dự
                  án, xây dựng 5 trường học và 2 trạm y tế tại các tỉnh miền núi
                  phía Bắc.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className='list-disc pl-5 space-y-1'>
                  <li>
                    Giải thưởng "Tổ chức phi lợi nhuận tiêu biểu" năm 2021
                  </li>
                  <li>Hỗ trợ giáo dục cho hơn 5,000 trẻ em vùng cao</li>
                  <li>
                    Xây dựng 5 trường học và 2 trạm y tế tại các tỉnh miền núi
                    phía Bắc
                  </li>
                  <li>
                    Tổ chức 15 chương trình khám chữa bệnh miễn phí cho người
                    dân vùng cao
                  </li>
                </ul>
              </div>
