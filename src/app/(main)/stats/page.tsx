    ...
    return (
      <div className='flex items-end h-60 gap-2 mt-4 mb-2'>
        {dailyTransactions.map((item, index) => {
          ...
          const prevHeight =
            index > 0
              ? (dailyTransactions[index - 1].count / maxCount) * 100
              : 0;
          ...
          return (
            ...
            >
              ...
              <div className='text-xs mt-2 text-muted-foreground rotate-45 origin-left'>
                {item.day}
              </div>
            </div>
          );
        ...
        <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
          <div>
            ...
            <p className='text-muted-foreground'>
              Theo dõi số liệu và hiệu suất blockchain của nền tảng từ thiện
            </p>
          </div>
              ...
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <h3 className='text-2xl font-bold mt-1'>
                    {blockchainMetrics.totalTransactions}
                  </h3>
                </div>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <h3 className='text-2xl font-bold mt-1'>
                    {blockchainMetrics.activeWallets}
                  </h3>
                </div>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <h3 className='text-2xl font-bold mt-1'>
                    {blockchainMetrics.avgTransactionFee}
                  </h3>
                </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
          <Card className='lg:col-span-2'>
            <CardHeader>
              ...
              <CardDescription>
                Số lượng giao dịch và khối lượng theo ngày trong 10 ngày qua
              </CardDescription>
            </CardHeader>
            <CardContent>{renderLineChart()}</CardContent>
            <CardFooter className='flex justify-between border-t pt-4'>
              <div className='text-sm text-muted-foreground'>
                <span className='font-medium text-foreground'>Tổng số:</span>{' '}
                1,773 giao dịch
              </div>
              <div className='text-sm text-muted-foreground'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Phân loại giao dịch theo chức năng
              </CardDescription>
            </CardHeader>
          ...
          <TabsContent value='transactions'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Các giao dịch blockchain mới nhất trên nền tảng
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardFooter className='border-t pt-4 flex justify-between'>
                <div className='text-sm text-muted-foreground'>
                  Hiển thị 5 trên tổng số 1,773 giao dịch
                </div>
          ...
          <TabsContent value='gas'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Số liệu thống kê về phí gas hiện tại trên mạng
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className='space-y-4'>
                    ...
                    <div className='space-y-3'>
                      <div>
                        ...
                        <div className='text-xs text-muted-foreground'>
                          Tương đương{' '}
                          <span className='font-medium'>~$6.84 USD</span>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className='text-2xl font-bold'>
                          {gasData.avgConfirmation}
                        </div>
                        <div className='text-xs text-muted-foreground'>
                          Trung bình cho các giao dịch
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='h-60 border rounded-lg flex items-center justify-center'>
                    <div className='text-center text-muted-foreground'>
                      ...
                      <p className='text-sm'>
                        Dữ liệu được lấy từ mạng Ethereum
                      </p>
                    </div>
                  </div>
          ...
          <TabsContent value='network'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Thông tin về hiệu suất và sức khỏe của mạng Ethereum
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className='text-2xl font-bold'>
                      {blockchainHealth.networkUtilization}%
                    </div>
                    <div className='text-xs text-muted-foreground'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className='text-xs text-muted-foreground'>
                      Thời gian hoạt động 99.98% trong 30 ngày qua
                    </div>
                  </div>
                </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='h-60 border rounded-lg flex items-center justify-center'>
                    <div className='text-center text-muted-foreground'>
                      ...
                      <p>
                        Biểu đồ phân bổ người xác thực sẽ được hiển thị ở đây
                      </p>
                      <p className='text-sm'>
                        Hiển thị phân bổ của các nhóm người xác thực trên mạng
                      </p>
                    </div>
                  </div>
