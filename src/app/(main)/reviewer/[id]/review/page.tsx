    ...
    <div className='container mx-auto px-4 py-6 max-w-4xl'>
      ...
      <Alert className='mb-6 border-orange-200 bg-orange-50'>
        ...
        <AlertDescription className='space-y-2'>
          <p>
            • Quyết định của bạn sẽ ảnh hưởng đến kết quả cuối cùng của chiến
            dịch
          </p>
          <p>
            • Bạn chỉ nhận phí nếu quyết định của mình khớp với kết quả cuối
            cùng (&gt;50% votes)
          </p>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='flex items-start space-x-3 p-4 border rounded-lg hover:bg-green-50 transition-colors'>
                    ...
                    <div className='flex-1 space-y-2'>
                      <Label
                        htmlFor='approve'
                        className='font-medium flex items-center text-green-700'
                      >
                        <CheckCircle className='h-4 w-4 mr-2' />
                        Chấp nhận chiến dịch
                      </Label>
                      <p className='text-sm text-muted-foreground'>
                        Chiến dịch đáp ứng đầy đủ các yêu cầu và có thể được
                        công khai để quyên góp
                      </p>
                  ...
                  <div className='flex items-start space-x-3 p-4 border rounded-lg hover:bg-red-50 transition-colors'>
                    ...
                    <div className='flex-1 space-y-2'>
                      <Label
                        htmlFor='reject'
                        className='font-medium flex items-center text-red-700'
                      >
                        <XCircle className='h-4 w-4 mr-2' />
                        Từ chối chiến dịch
                      </Label>
                      <p className='text-sm text-muted-foreground'>
                        Chiến dịch vi phạm quy định hoặc không đáp ứng yêu cầu
                        cơ bản
                      </p>
                      <ul className='text-xs text-muted-foreground space-y-1 ml-6'>
              ...
              <div className='space-y-3 text-sm'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span className='font-medium text-green-600'>
                    {new Intl.NumberFormat('vi-VN').format(reviewItem.amount)}{' '}
                    VNĐ
                  </span>
                </div>
                <div className='flex justify-between'>
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='space-y-2'>
                ...
                <div className='text-xs text-muted-foreground'>
                  Cần thêm{' '}
                  {reviewItem.requiredReviewers - reviewItem.reviewersCount}{' '}
                  người duyệt
                </div>
              </div>
            </CardContent>
