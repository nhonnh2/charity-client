        ...
        <div className="md:col-span-2 space-y-6">
          <div className="relative h-64 md:h-96 w-full overflow-hidden rounded-lg">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 text-white">
              <Badge className="mb-2 bg-green-600 hover:bg-green-700">Giáo dục</Badge>
              <h1 className="text-2xl font-bold md:text-3xl">Xây trường học cho trẻ em vùng cao</h1>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center space-x-4">
              <Avatar className="h-10 w-10">
                <AvatarImage src="/placeholder.svg?height=50&width=50" alt="Avatar" />
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Đã xác minh danh tính</p>
              </div>
            </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-muted-foreground">Kết thúc: 30/06/2023</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p>
                  Chiến dịch "Xây trường học cho trẻ em vùng cao" nhằm mục đích xây dựng một trường học mới cho hơn 200
                  trẻ em tại xã Tả Phìn, huyện Sa Pa, tỉnh Lào Cai. Hiện tại, trẻ em ở đây phải đi bộ hơn 5km đường núi
                  để đến trường, gặp nhiều khó khăn trong mùa mưa.
                </p>
                <p>
                  Trường học mới sẽ có 6 phòng học, 1 thư viện nhỏ, và các thiết bị cơ bản phục vụ việc học tập. Dự án
                  được chia thành 3 giai đoạn, với tổng kinh phí dự kiến là 100 triệu đồng.
                </p>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Chiến dịch được chia thành 3 giai đoạn với mục tiêu và thời gian cụ thể</CardDescription>
            </CardHeader>
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold">Giai đoạn 1: Hoàn thành móng và khung</h3>
                      <p className="text-sm text-muted-foreground">01/04/2023 - 30/04/2023</p>
                    </div>
                  </div>
                ...
                <div className="ml-11 space-y-2">
                  <p className="text-sm">
                    Đào móng, đổ bê tông và xây dựng khung chính của trường học. Giai đoạn này đã hoàn thành với sự tham
                    gia của 15 tình nguyện viên địa phương.
                  </p>
                  <div className="flex items-center space-x-2">
                    <Button variant="outline" size="sm" className="flex items-center gap-1">
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold">Giai đoạn 2: Xây tường và mái</h3>
                      <p className="text-sm text-muted-foreground">01/05/2023 - 31/05/2023</p>
                    </div>
                  </div>
                  <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-100">Đang thực hiện</Badge>
                </div>
                <div className="ml-11 space-y-2">
                  <p className="text-sm">
                    Xây tường, lắp đặt cửa sổ, cửa ra vào và hoàn thiện mái nhà. Hiện tại đã hoàn thành khoảng 60% công
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold">Giai đoạn 3: Hoàn thiện và trang thiết bị</h3>
                      <p className="text-sm text-muted-foreground">01/06/2023 - 30/06/2023</p>
                    </div>
                  </div>
                ...
                <div className="ml-11 space-y-2">
                  <p className="text-sm">
                    Hoàn thiện nội thất, lắp đặt bàn ghế, bảng, và các thiết bị học tập cơ bản. Dự kiến khánh thành
                    trường vào đầu tháng 7/2023.
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <Tabs defaultValue="updates">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1">
                          Chúng tôi vừa hoàn thành 60% giai đoạn 2! Cảm ơn tất cả mọi người đã đóng góp và ủng hộ. Dưới
                          đây là một số hình ảnh cập nhật về tiến độ xây dựng.
                        </p>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1">
                          Chúng tôi đã bắt đầu giai đoạn 2 của dự án! Cảm ơn tất cả mọi người đã đóng góp. Chúng tôi đã
                          mua vật liệu xây dựng và thuê thêm nhân công để đẩy nhanh tiến độ.
                        </p>
                        <div className="mt-2 flex items-center space-x-4">
                          <button className="flex items-center space-x-1 text-muted-foreground hover:text-foreground">
                            <Heart className="h-4 w-4" />
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1">
                          Dự án rất ý nghĩa! Tôi đã đóng góp và sẽ chia sẻ với bạn bè. Chúc dự án thành công!
                        </p>
                        <div className="mt-2 flex items-center space-x-4">
                          <button className="flex items-center space-x-1 text-muted-foreground hover:text-foreground">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1">
                          Tôi rất ấn tượng với sự minh bạch của dự án này. Việc sử dụng blockchain để theo dõi các giao
                          dịch là một ý tưởng tuyệt vời. Tôi sẽ tiếp tục theo dõi và ủng hộ!
                        </p>
                        <div className="mt-2 flex items-center space-x-4">
                          <button className="flex items-center space-x-1 text-muted-foreground hover:text-foreground">
                            <ThumbsUp className="h-4 w-4" />
                      ...
                      <div key={i} className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <Avatar className="h-8 w-8">
                            <AvatarImage src={`/placeholder.svg?height=40&width=40&text=D${i}`} alt="Donor" />
                            <AvatarFallback>D{i}</AvatarFallback>
                          </Avatar>
                          <div>
                            <div className="font-medium">Người đóng góp {i}</div>
                            <div className="text-xs text-muted-foreground">{i} ngày trước</div>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="font-medium">{(i * 1000000).toLocaleString()} VNĐ</div>
                          {i === 2 && <div className="text-xs text-muted-foreground">Ẩn danh</div>}
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <TabsContent value="transactions" className="mt-4 space-y-4">
                  <div className="space-y-3">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div key={i} className="flex items-center justify-between border-b pb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="text-sm font-medium">
                              {i % 3 === 0 ? "Đóng góp" : i % 3 === 1 ? "Giải ngân" : "Xác nhận giai đoạn"}
                            </h4>
                        ...
                        <div className="text-right">
                          {i % 3 !== 2 && <div className="font-medium">{(i * 1000000).toLocaleString()} VNĐ</div>}
                  ...
                  <Button variant="outline" className="w-full" asChild>
                    <Link href="/transactions">Xem tất cả giao dịch onchain</Link>
                  </Button>
                </TabsContent>
              </Tabs>
            </CardContent>
        ...
        <div className="space-y-6">
          <Card className="sticky top-6">
            <CardHeader>
              ...
              <CardDescription>Mọi đóng góp đều được ghi lại trên blockchain để đảm bảo tính minh bạch</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {[1, 2, 3].map((i) => (
                <Link href={`/campaigns/${i + 10}`} key={i} className="flex items-start space-x-3 group">
                  <img
