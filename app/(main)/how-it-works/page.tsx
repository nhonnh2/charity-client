...
function Step({ icon: Icon, title, description, iconClassName = "text-primary" }: StepProps) {
  return (
...
function ProcessStep({ step, title, description, isLeft = true }: ProcessStepProps) {
  return (
  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 py-8">
      <div className="space-y-2 mb-8">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Cách thức hoạt động</h1>
        <p className="text-xl text-muted-foreground">
          TrustCharity sử dụng công nghệ blockchain để đảm bảo tính minh bạch và trách nhiệm trong mọi chiến dịch từ
          thiện.
        </p>
      </div>
      ...
      <div className="mb-16">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Hiểu rõ quy trình từ khi tạo chiến dịch đến khi hoàn thành</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="mb-16">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Hiểu cách chúng tôi sử dụng blockchain để đảm bảo tính minh bạch</CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs defaultValue="what" className="w-full">
              ...
              <TabsContent value="what">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-xl font-semibold mb-4">Blockchain là gì?</h3>
                    <p className="text-muted-foreground mb-4">
                      Blockchain là một công nghệ sổ cái phân tán, ghi lại các giao dịch theo cách không thể thay đổi và
                      minh bạch. Mỗi "khối" chứa một số giao dịch, và một khi được thêm vào "chuỗi", không thể chỉnh sửa
                      hoặc xóa.
                    </p>
                    <p className="text-muted-foreground">
                      Trong TrustCharity, chúng tôi sử dụng blockchain Polygon - một giải pháp Layer 2 của Ethereum với
                      phí giao dịch thấp và tốc độ cao, phù hợp cho các ứng dụng từ thiện.
                    </p>
                  </div>
                  <div className="flex items-center justify-center">
                    <div className="relative w-full h-64 bg-muted rounded-lg flex items-center justify-center">
                      <Info className="h-8 w-8 text-muted-foreground/50" />
                      <span className="text-muted-foreground/70 absolute bottom-4 text-sm">Blockchain Diagram</span>
                    </div>
                  </div>
                </div>
              </TabsContent>
              <TabsContent value="how">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-xl font-semibold mb-4">Cách hoạt động trong TrustCharity</h3>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                        <span>Mỗi chiến dịch được tạo như một smart contract trên blockchain Polygon</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                        <span>Mọi đóng góp được ghi lại như một giao dịch trên blockchain</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                        <span>Tiền được giữ trong smart contract và chỉ giải ngân khi đạt đủ điều kiện</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                        <span>Người đóng góp có thể bỏ phiếu xác nhận giai đoạn thông qua smart contract</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                        <span>Mọi giao dịch đều có thể kiểm tra trên Polygon Explorer</span>
                      </li>
                    </ul>
                    <div className="mt-6">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="relative w-full h-64 bg-muted rounded-lg flex items-center justify-center">
                      <Info className="h-8 w-8 text-muted-foreground/50" />
                      <span className="text-muted-foreground/70 absolute bottom-4 text-sm">Smart Contract Flow</span>
                    </div>
                  </div>
                </div>
              </TabsContent>
              <TabsContent value="benefits">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-xl font-semibold mb-4">Lợi ích của blockchain trong từ thiện</h3>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                        <div>
                      ...
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                        <div>
                          <span className="font-medium">Không thể thay đổi:</span>
                          <span className="text-muted-foreground"> Dữ liệu đã ghi không thể chỉnh sửa hoặc xóa</span>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                        <div>
                          <span className="font-medium">Giảm chi phí trung gian:</span>
                          <span className="text-muted-foreground"> Loại bỏ các bên trung gian, giảm phí</span>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                        <div>
                          ...
                          <span className="text-muted-foreground">
                            {" "}
                            Smart contract tự động thực hiện các điều kiện đã định
                          </span>
                        </div>
                      </li>
                      <li className="flex items-start">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="relative w-full h-64 bg-muted rounded-lg flex items-center justify-center">
                      <Info className="h-8 w-8 text-muted-foreground/50" />
                      <span className="text-muted-foreground/70 absolute bottom-4 text-sm">Blockchain Benefits</span>
                    </div>
                  </div>
                </div>
              </TabsContent>
      ...
      <div className="mb-16">
        <Card className="overflow-hidden">
          <CardHeader className="bg-primary/5">
            ...
            <CardDescription>Xem tất cả giao dịch được ghi lại trên blockchain</CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Tất cả giao dịch trên TrustCharity đều được ghi lại trên blockchain Polygon, đảm bảo tính minh bạch và
                  không thể chỉnh sửa. Bạn có thể xem tất cả giao dịch công khai bất kỳ lúc nào.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                  ...
                  <li className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                    <span>Kiểm tra chi tiết giao dịch trên Polygon Explorer</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-0.5 shrink-0" />
                    <span>Lọc giao dịch theo chiến dịch, loại, hoặc thời gian</span>
                  </li>
                </ul>
                <div className="pt-2">
              ...
              <div className="flex items-center justify-center">
                <div className="relative w-full h-64 bg-muted rounded-lg flex items-center justify-center">
                  <Info className="h-8 w-8 text-muted-foreground/50" />
                  <span className="text-muted-foreground/70 absolute bottom-4 text-sm">Transactions Dashboard</span>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      <div className="mb-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Tham gia cộng đồng TrustCharity và bắt đầu đóng góp hoặc tạo chiến dịch</CardDescription>
          </CardHeader>
