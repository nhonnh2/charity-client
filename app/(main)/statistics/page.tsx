...
export default function StatisticsPage() {
  ...
  const categoryDistribution = [
    { category: "Giáo dục", percentage: 35, amount: "1.82 tỷ VNĐ", color: "bg-blue-500" },
    { category: "Y tế", percentage: 28, amount: "1.46 tỷ VNĐ", color: "bg-green-500" },
    { category: "Môi trường", percentage: 20, amount: "1.04 tỷ VNĐ", color: "bg-amber-500" },
    { category: "Cơ sở hạ tầng", percentage: 12, amount: "624 triệu VNĐ", color: "bg-purple-500" },
    { category: "Khác", percentage: 5, amount: "260 triệu VNĐ", color: "bg-gray-500" },
  ]
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Tổng quan về hoạt động và đóng góp trên nền tảng từ thiện blockchain
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Tổng số chiến dịch</p>
                  <h3 className="text-2xl font-bold mt-1">{overviewStats.totalCampaigns}</h3>
                </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Tổng số đóng góp</p>
                  <h3 className="text-2xl font-bold mt-1">{overviewStats.totalDonations}</h3>
                </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Tổng số người đóng góp</p>
                  <h3 className="text-2xl font-bold mt-1">{overviewStats.totalDonors}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold mt-1">{overviewStats.successRate}%</h3>
                </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Đóng góp trung bình</p>
                  <h3 className="text-2xl font-bold mt-1">{overviewStats.avgDonation}</h3>
                </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Tổng số giao dịch</p>
                  <h3 className="text-2xl font-bold mt-1">{overviewStats.totalTransactions}</h3>
                </div>
                <div className="h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Tổng số tiền đóng góp theo từng tháng trong năm 2025 (đơn vị: triệu VNĐ)
              </CardDescription>
            </CardHeader>
            <CardContent>{renderBarChart()}</CardContent>
            <CardFooter className="flex justify-between border-t pt-4">
              <div className="text-sm text-muted-foreground">
                <span className="font-medium text-foreground">Tổng cộng:</span> 5.2 tỷ VNĐ
              </div>
              <div className="text-sm text-muted-foreground">
                <span className="font-medium text-foreground">Trung bình:</span> 433 triệu VNĐ/tháng
              </div>
            </CardFooter>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Phân bổ đóng góp theo từng danh mục chiến dịch</CardDescription>
            </CardHeader>
            <CardContent>
              {renderPieChart()}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Select defaultValue="raised">
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="progress">Tiến độ hoàn thành</SelectItem>
                      <SelectItem value="recent">Mới nhất</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <CardDescription>Những chiến dịch có số lượng đóng góp cao nhất trên nền tảng</CardDescription>
              </CardHeader>
              <CardContent>
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                            ...
                            <div className="text-right shrink-0">
                              ...
                              <div className="text-xs text-muted-foreground">{campaign.donors} người đóng góp</div>
                            </div>
                          </div>
                          <div className="mt-2 space-y-1">
                            ...
                            <div className="flex justify-between text-xs">
                              ...
                              <span className="text-muted-foreground">Mục tiêu: {campaign.goal}</span>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="grid gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Số liệu thống kê về các giao dịch blockchain trên nền tảng</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2">
                      <div className="text-sm text-muted-foreground">Phí gas trung bình</div>
                      <div className="text-2xl font-bold">{blockchainStats.avgGasFee}</div>
                      <div className="text-xs text-muted-foreground flex items-center gap-1">
                    ...
                    <div className="space-y-2">
                      <div className="text-sm text-muted-foreground">Thời gian xác nhận trung bình</div>
                      <div className="text-2xl font-bold">{blockchainStats.avgConfirmationTime}</div>
                      <div className="text-xs text-muted-foreground flex items-center gap-1">
                        <ArrowDown className="h-3 w-3 text-green-500" />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-2xl font-bold">{blockchainStats.successfulTransactions}</div>
                      <div className="text-xs text-muted-foreground">
                        <span className="text-green-500 font-medium">99.9%</span> tỷ lệ thành công
                      </div>
                    </div>

                    <div className="space-y-2">
                      <div className="text-sm text-muted-foreground">Giao dịch thất bại</div>
                      <div className="text-2xl font-bold">{blockchainStats.failedTransactions}</div>
                      <div className="text-xs text-muted-foreground">
                        <span className="text-red-500 font-medium">0.1%</span> tỷ lệ thất bại
                      </div>
                    </div>

                    <div className="space-y-2">
                      <div className="text-sm text-muted-foreground">Tổng phí gas đã sử dụng</div>
                      <div className="text-2xl font-bold">{blockchainStats.totalGasUsed}</div>
                      <div className="text-xs text-muted-foreground">
                        Tương đương <span className="font-medium">~62.3 triệu VNĐ</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold">Phân bổ giao dịch theo loại</h4>
          ...
          <TabsContent value="activities">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Các hoạt động mới nhất trên nền tảng từ thiện blockchain</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  {recentActivities.map((activity) => (
                    <div key={activity.id} className="flex items-start gap-4 border-b pb-4 last:border-0 last:pb-0">
                      ...
                      >
                        ...
                        {activity.type === "withdrawal" && <Wallet className="h-5 w-5" />}
                        {activity.type === "campaign_completed" && <TrendingUp className="h-5 w-5" />}
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
                          <div>
                            <div className="font-medium">
                              {activity.type === "donation" && `${activity.user} đã đóng góp cho chiến dịch`}
                              {activity.type === "campaign_created" && `${activity.user} đã tạo chiến dịch mới`}
                              {activity.type === "withdrawal" && `${activity.user} đã rút tiền từ chiến dịch`}
                              {activity.type === "campaign_completed" &&
                                `Chiến dịch đã hoàn thành bởi ${activity.user}`}
                            </div>
                            <div className="text-sm text-muted-foreground truncate">{activity.campaign}</div>
                          </div>
                          <div className="text-sm text-right shrink-0">
                            <div className="font-medium">{activity.amount || activity.goal || activity.raised}</div>
                        ...
                        <div className="mt-2">
                          <div className="text-xs text-muted-foreground flex items-center gap-1">
                            ...
                            <code className="bg-muted px-1 py-0.5 rounded text-xs">{activity.txHash}</code>
                          </div>
                        </div>
                      </div>
                    </div>
