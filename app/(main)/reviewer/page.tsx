...
interface ReviewItem {
    ...
    type: 'new_campaign' | 'campaign_edit' | 'campaign_addition' | 'campaign_restart';
...
export default function ReviewerDashboard() {
    ...
    const getStatusBadge = (item: ReviewItem) => {
        ...
        switch (item.status) {
            case 'pending':
                return <Badge variant="secondary" className="bg-blue-100 text-blue-800">Chờ duyệt</Badge>;
            case 'in_review':
                return <Badge variant="secondary" className="bg-yellow-100 text-yellow-800">Đang duyệt</Badge>;
            case 'needs_more_reviewers':
                return <Badge variant="secondary" className="bg-orange-100 text-orange-800">Cần thêm người duyệt</Badge>;
            default:
                ...
                <div className="text-center space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">
                            Bạn chưa đăng ký làm người duyệt. Hãy đăng ký để bắt đầu kiếm thu nhập từ việc duyệt chiến dịch.
                        </p>
                    </div>
                    <Card className="max-w-md mx-auto">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center space-x-3">
                                <CheckCircle className="h-5 w-5 text-green-500" />
                                <span className="text-sm">Đã đóng góp cho ít nhất 5 chiến dịch</span>
                            </div>
                        </CardContent>
                        <CardFooter>
    ...
    return (
        <div className="container mx-auto px-4 py-6 max-w-7xl">
            <div className="mb-6">
                <h1 className="text-2xl font-bold tracking-tight">Bảng điều khiển người duyệt</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl font-bold text-green-600">
                                    {new Intl.NumberFormat('vi-VN').format(reviewerStats.totalEarned)} VNĐ
                                </p>
                            </div>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl font-bold">{reviewerStats.completedReviews}</p>
                            </div>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl font-bold text-green-600">{reviewerStats.successfulReviews}</p>
                            </div>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl font-bold text-red-600">{reviewerStats.failedReviews}</p>
                            </div>
                ...
                <Card>
                    <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-muted-foreground">Tổng người duyệt</p>
                                <p className="text-xl font-bold text-blue-600">{new Intl.NumberFormat('vi-VN').format(reviewerStats.totalReviewers)}</p>
                            </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
                ...
                <TabsContent value="new" className="space-y-4">
                            ...
                            <Card>
                                <CardContent className="p-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select value={filters.type} onValueChange={(value) => setFilters(prev => ({ ...prev, type: value }))}>
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="new_campaign">Chiến dịch mới</SelectItem>
                                                    <SelectItem value="campaign_edit">Chỉnh sửa</SelectItem>
                                                    <SelectItem value="campaign_addition">Bổ sung</SelectItem>
                                                    <SelectItem value="campaign_restart">Khởi động lại</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
                                        <div className="space-y-2">
                                            ...
                                            <Select>
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="medium">50,000 - 100,000 VNĐ</SelectItem>
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-sm font-medium">Uy tín người tạo</label>
                                            <Select>
                                                <SelectTrigger>
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-sm font-medium">Thời hạn còn lại</label>
                                            <Select>
                                                <SelectTrigger>
                    ...
                    <div className="space-y-4">
                        {reviewItems.filter(item => !item.hasVoted).map((item) => (
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1 space-y-3">
                                            <div className="flex items-start justify-between">
                                                <div>
                                                    <h3 className="font-semibold text-lg">{item.campaignTitle}</h3>
                                            ...
                                            <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                                                ...
                                                <span className="flex items-center">
                                                    ...
                                                    {item.reviewersCount}/{item.requiredReviewers} người duyệt
                                                </span>
                                                <span className="flex items-center">
                                                ...
                                                <span className="flex items-center">
                                                    ...
                                                    {new Intl.NumberFormat('vi-VN').format(item.fee)} VNĐ
                                                </span>
                                            </div>
                                                ...
                                                <div className="space-y-1">
                                                    <div className="flex items-center space-x-2 text-xs text-muted-foreground">
                                                        ...
                                                        <span className="font-medium">
                                                            {Math.round((item.reviewersCount / item.requiredReviewers) * 100)}%
                                                        </span>
                                                    </div>
                                                    <Progress
                                                        value={(item.reviewersCount / item.requiredReviewers) * 100}
                                                        className="w-32 h-2"
                                                    />
                                                </div>
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    <Link href={`/reviewer/${item.id}/review?action=approve`}>
                                                        <Button size="sm" variant="outline" className="border-green-300 text-green-700 hover:bg-green-50">
                                                            <CheckCircle className="h-4 w-4 mr-2" />
                                                            Chấp nhận
                                                        </Button>
                                                    </Link>
                                                    <Link href={`/reviewer/${item.id}/review?action=reject`}>
                ...
                <TabsContent value="trending" className="space-y-4">
                    <div className="flex items-center justify-between">
                        <h2 className="text-lg font-semibold">Yêu cầu được quan tâm nhất</h2>
                        <div className="flex items-center space-x-2">
                            <Flame className="h-4 w-4 text-orange-500" />
                            <span className="text-sm text-muted-foreground">Sắp xếp theo lượt quan tâm</span>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        {reviewItems
                            ...
                            .map((item) => (
                                <Card key={item.id} className="hover:shadow-md transition-shadow border-orange-100">
                                    <CardContent className="p-6">
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1 space-y-3">
                                                <div className="flex items-start justify-between">
                ...
                <TabsContent value="completed" className="space-y-4">
                    ...
                    <div className="space-y-4">
                        {reviewItems.filter(item => item.hasVoted).map((item) => {
                            ...
                            const myDecision = Math.random() > 0.5 ? 'approved' : 'rejected';
                            const finalResult = Math.random() > 0.3 ? 'approved' : 'rejected';
                            const isCorrect = myDecision === finalResult;

                            return (
                                <Card key={item.id} className={`${isCorrect ? 'border-green-200 bg-green-50/30' : 'border-red-200 bg-red-50/30'}`}>
                                    <CardContent className="p-6">
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                <h3 className="font-semibold">{item.campaignTitle}</h3>
                                                ...
                                                <div className="mt-3 space-y-2">
                                                    <div className="flex items-center space-x-4 text-sm">
                                                        <div className="flex items-center space-x-2">
                                                            <span className="text-muted-foreground">Lựa chọn của tôi:</span>
                                                            {myDecision === 'approved' ? (
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            <span className="text-muted-foreground">Kết quả cuối:</span>
                ...
                <TabsContent value="urgent" className="space-y-4">
                    ...
                    <div className="space-y-4">
                        {reviewItems.filter(item => item.priority === 'high' && !item.hasVoted).map((item) => (
