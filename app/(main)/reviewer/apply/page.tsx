...
export default function ReviewerApplicationPage() {
    ...
    const allRequirementsMet = requirements.filter(req => !req.optional).every(req => req.met);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast.success('Đã gửi đơn đăng ký thành công! Chúng tôi sẽ xem xét và phản hồi trong vòng 3-5 ngày làm việc.');
        ...
        <div className="container mx-auto px-4 py-6 max-w-4xl">
            ...
            <div className="mb-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">Đăng ký làm người duyệt</h1>
                    <p className="text-muted-foreground">
                        Gia nhập đội ngũ người duyệt và giúp đảm bảo chất lượng các chiến dịch từ thiện
                    </p>
                </div>
            </div>
                        ...
                        <CardContent className="space-y-4">
                            {requirements.map((req, index) => (
                                <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                                    <div className="flex items-center space-x-3">
                                        <div className={`${req.met ? 'text-green-600' : 'text-red-600'}`}>
                                            {req.met ? <CheckCircle className="h-5 w-5" /> : <XCircle className="h-5 w-5" />}
                                        </div>
                                        <div className="flex-1">
                                            <div className="flex items-center space-x-2">
                                                {req.icon}
                                                <span className="font-medium">{req.label}</span>
                                                {req.optional && <Badge variant="outline" className="text-xs">Tùy chọn</Badge>}
                                            </div>
                            ...
                            {!allRequirementsMet && (
                                <Alert>
                                    ...
                                    <AlertDescription>
                                        Bạn cần hoàn thành các yêu cầu còn lại trước khi có thể đăng ký làm người duyệt.
                                    </AlertDescription>
                                </Alert>
                            )}
                        </CardContent>
                    ...
                    <Card>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-start space-x-2">
                                        <Checkbox
                                            ...
                                            onCheckedChange={(checked) => setFormData(prev => ({ ...prev, agreeToCommitment: checked as boolean }))}
                                        />
                                        <Label htmlFor="commitment" className="text-sm leading-relaxed cursor-pointer">
                                            Tôi cam kết thực hiện nghĩa vụ người duyệt một cách công bằng, trung thực và có trách nhiệm.
                                            Tôi hiểu rằng quyết định duyệt của tôi sẽ ảnh hưởng đến cộng đồng và các chiến dịch từ thiện.
                                        </Label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <CardFooter>
                            <Button
                                ...
                                disabled={!allRequirementsMet || isSubmitting || !formData.agreeToTerms || !formData.agreeToCommitment}
                                className="w-full"
                            >
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-2 gap-4 text-center">
                                ...
                                <div>
                                    <p className="text-2xl font-bold text-green-600">{userStats.campaignsSupported}</p>
                                    <p className="text-xs text-muted-foreground">Chiến dịch ủng hộ</p>
                                </div>
                                <div>
                                    <p className="text-2xl font-bold text-orange-600">{userStats.completedCampaigns}</p>
